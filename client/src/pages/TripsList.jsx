    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <h1 className="text-2xl sm:text-4xl font-bold text-gray-900">My Trips</h1>
          <button
        ...
        {showNewTrip && (
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-8">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Create New Trip</h2>
            <form onSubmit={handleCreateTrip} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <button
                type="submit"
                className="sm:col-span-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition"
              >
                Create Trip
              </button>
            </form>
        ...
        {loading ? (
            ...
            {filteredTrips.map((trip) => (
              ...
              >
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-4 sm:px-6 py-4">
                  <h3 className="text-lg sm:text-xl font-semibold text-white">{trip.name}</h3>
                  {trip.destination && <p className="text-blue-100 text-sm sm:text-base">{trip.destination}</p>}
                </div>
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button
                      ...
                      className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold transition text-sm sm:text-base"
                    >
                      View
                    </button>
                    <button
                      onClick={() => handleDeleteTrip(trip._id)}
                      className="flex-1 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-semibold transition text-sm sm:text-base"
                    >
                      Delete
                    </button>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow p-8 sm:p-12 text-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">No trips found</h2>
            <p className="text-gray-600 mb-6 text-sm sm:text-base">Create your first trip or adjust your filters</p>
            <button
